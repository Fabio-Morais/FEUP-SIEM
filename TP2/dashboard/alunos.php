...
<div class="modal fade " id="modalGradeForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
                ...
                <article class="card-body mx-auto ">
                    ...
                    <form method="POST" action="action/actionAddGradeStudent.php">
                        <div class="form-group input-group mt-3 ">
                            ...
                            <input name="user" class="form-control" placeholder="Nota" type="text" id="usernam"
                                   readonly="readonly">
                        </div>
                        <div class="form-group input-group mt-3 ">
                            <div class="input-group-prepend">
                            ...
                            <input name="grade" class="form-control" placeholder="Nota" type="number" min="0" max="20"
                                   required>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 m-1">
                                <div class="profile-card-4 z-depth-3">
                                    <div class="card">
                                        <div class="card-body text-center rounded-top" id="modalColor"
                                             style="background-color:#8585d3">
                                            <div class="user-box">
                                                <img src="public/img/" alt="user avatar"
                                                     onerror="javascript:this.src='public/img/avatar.png'">
                                            </div>
                                            <h5 class="mb-1 textAdapt2" id="name"><!-- USERNAME HERE --></h5>
                                            <h6 class="textAdapt2">Aluno</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="list-group-item d-flex flex-wrap flex-row justify-content-center">
                                                ...
                                                <div class="list-details m-2 text-center d-flex flex-row flex-wrap justify-content-center">
                                                    ...
                                                    <div class="mr-2 mt-2"><span
                                                                class="modalPhone"><!-- PHONE HERE --></span></div>
                                                </div>

                                                <div class="list-details m-2 text-center d-flex flex-row flex-wrap justify-content-center">
                                                    <div class="ml-2"><i class="fa fa-envelope fa-lg"></i></div>
                                                    <div class="ml-2 mt-2"><span
                                                                class="modalEmail"> <!-- EMAIL HERE --></span></div>
                                                </div>
                                            </div>

                                            <div class="row text-center mt-4">
                                                <div class="col p-2">
                                                    <h4 class="mb-1 line-height-5" id="countCourse">
                                                        <!-- COUNT COURSE HERE --></h4>
