                            ...
                            <div class="tab-pane active show" id="edit">
                                <form>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" value="<?php echo $queryInfo['name'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Email</label>
                                        <div class="col-lg-9">
                                            <input class="form-control" type="email" value="<?php echo $queryInfo['email'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" value="<?php echo $queryInfo['nif'];?>" placeholder="NIF">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" type="date" value="<?php echo $queryInfo['birthdate']?>"><!--YYYY-MM-DD-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" value="<?php echo $queryInfo['username'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
