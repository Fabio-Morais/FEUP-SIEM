                            ...
                            <article class="filter-group ">
                                ...
                                <div class="filter-content collapse show " id="collapse_1" style="">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-menu">
                                            <li><a type="button" class="menuCategory text-primary font-weight-bold"
                                                   onclick="categoryFunction(this)" data-value="all">Todos </a></li>
                                            <li><a type="button" class="menuCategory" onclick="categoryFunction(this)"
                                                   data-value="soft">Software </a></li>
                                            <li><a type="button" class="menuCategory" onclick="categoryFunction(this)"
                                                   data-value="ml">Machine Learning </a></li>
                                            <li><a type="button" class="menuCategory" onclick="categoryFunction(this)"
                                                   data-value="web">Web Development </a></li>
                                        </ul>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Min</label>
                                                <input class="form-control minPrice" placeholder="0€" type="number"
                                                       name="minPrice" value="0">
                                            </div>
                                            <div class="form-group text-right col-md-6">
                                                <label>Max</label>
                                                <input class="form-control maxPrice" placeholder="100€" type="number"
                        ...
                        <div class="d-flex flex-wrap justify-content-start items">
                            ...
                            if ($connected) :
                                ...
                                while (isset($row["coursename"])) {
                                    ...
                                    echo "  <div class=\"img-wrap\" type=\"button\" class=\"btn-overlay\" data-toggle=\"modal\" data-target=\"#exampleModalLong\" onclick=\"showProductDetail('" . $row["coursename"] . "')\">";
                                    echo "      <span class=\"badge badge-danger\"> Promo </span>";
                                    echo "      <img src=\"public/img/courses/" . $row["image"] . "\">";
                                    echo "      <a type=\"button\" class=\"btn-overlay\" data-toggle=\"modal\" data-target=\"#exampleModalLong\" onclick=\"showProductDetail('" . $row["coursename"] . "')\"><i class=\"fa fa-search-plus\" ></i> Info</a>";
                                    echo "  </div> ";
                                    echo "  <figcaption class=\"info-wrap\"> ";
                                    echo "      <div class=\"fix-height\"> ";
                                    echo "          <a type=\"button\" data-toggle=\"modal\" data-target=\"#exampleModalLong\" onclick=\"showProductDetail('" . $row["coursename"] . "')\" class=\"title text-capitalize \">" . $row["coursename"] . "</a> ";
            ...
            <footer class="cd-cart__footer">
                <a type="button" class="cd-cart__checkout" id="submitButton">
                    <em>Checkout : <span>0</span>€
                        <svg class="icon2 icon--sm" viewBox="0 0 24 24">
