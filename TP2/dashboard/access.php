...
}/*SO PARA ALUNOS*/ else if ($title ==  "avaliacao.php" ||  $title ==  "aula.php" ||  $title ==  "notas.php" ||  $title ==  "comprar_curso.php" ||  $title ==  "historico.php" ||  $title ==  "comprar_curso.php" ||  $title ==  "carrinho.php" ||  $title ==  "thankYou.php") {
    if ($role != 0) {
        header("Location: templates/common/401.html");
        exit();
    }
